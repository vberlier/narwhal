...
TEST(meta_group_test_failing_1) { FAIL(); }
TEST(meta_group_test_failing_2) { FAIL(); }
TEST(meta_group_test_failing_3) { FAIL(); }
TEST(meta_group_test_failing_4) { FAIL(); }
...
TEST_GROUP(meta_single_passing_group,
{
    meta_group_test_passing_1
})

TEST_GROUP(meta_single_failing_group,
{
    meta_group_test_failing_1
})

TEST_GROUP(meta_double_passing_group,
{
    meta_group_test_passing_1,
    meta_group_test_passing_2
})

TEST_GROUP(meta_double_failing_group,
{
    meta_group_test_failing_1,
    meta_group_test_failing_2
})

TEST_GROUP(meta_double_mixed_group,
{
    meta_group_test_passing_1,
    meta_group_test_failing_1
})
...
TEST_PARAM(meta_group, struct MetaGroup,
{
...
TEST(run_meta_group, meta_group)
{
    ...
    {
        status_code = RUN_TESTS(meta_group.handle);
    }
